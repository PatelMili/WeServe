...
class signUp extends Component {
    constructor(props) {
        ...
        this.signupngo = this.signupngo.bind(this);
                                ...
                                <div className="col-md-6">
                                    <div className="formProps">
                                        ...
                                        <div className="padding5 " style={{ "margin-top": "10px" }}>
                                            <input className="inputField" onChange={this.onChange} type="text" name="fname" placeholder="First Name"></input>

                                        </div>
                                        <div className="padding5 " style={{ "margin-top": "10px" }}>
                                            <input className="inputField" onChange={this.onChange} type="text" name="lname" placeholder="Last Name"></input>

                                        </div>

                                        <div className="padding5 " style={{ "margin-top": "10px" }}>
                                            <input className="inputField" onChange={this.onChange} type="text" name="username" placeholder="UserName"></input>

                                        </div>

                                        <div className="padding5 " style={{ "margin-top": "10px" }}>
                                            <input className="inputField" onChange={this.onChange} type="text" name="email_state" onChange={this.handleEmailChange} placeholder="Email address"></input>
                                            {errorEmail}
                                        </div>
                                        <div className="padding5">
                                            <input className="inputField" onChange={this.onChange} type="password" name="pwd" onChange={this.handlePasswordChange} placeholder="Password"></input>
                                            {errorPswd}
                                        </div>


                                        <div className="padding5 " style={{ "margin-top": "10px" }}>
                                            <input className="inputField" onChange={this.onChange} type="text" name="city" placeholder="City"></input>
                                        ...
                                        <div className="padding5 " style={{ "margin-top": "10px" }}>
                                            <input className="inputField" onChange={this.onChange} type="text" name="organisation_name" placeholder="Organization Name"></input>

                                        </div>

                                        <div className="padding5 " style={{ "margin-top": "10px" }}>
                                            <input className="inputField" onChange={this.onChange} type="text" name="contact_person" placeholder="Contact Person"></input>

                                        </div>
                                        <div className="padding5 " style={{ "margin-top": "10px" }}>
                                            <textarea className="inputField" onChange={this.onChange} type="text" name="description" placeholder="Description"/>
                                        </div>
                                        <div className="padding5 " style={{ "margin-top": "10px" }}>
                                            <textarea className="inputField" onChange={this.onChange} type="text" name="vision" placeholder="Vision"/>

                                        </div>
                                        <div className="padding5 " style={{ "margin-top": "10px" }}>
                                            <textarea className="inputField" onChange={this.onChange} type="text" name="mission" placeholder="Mission"/>

                                        </div>

                                        <div class="form-group padding5" style={{ "marginBottom": '0px' }}>
                                            <input type="submit" className="btn btn-primary  " onClick={this.signupngo} value="Sign Up" id="loginButton" tabindex="4" />
